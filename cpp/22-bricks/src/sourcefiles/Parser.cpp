...
Parser::Parser()
{
    m_command_map["game"] = new GameCommand();
    m_command_map["menu"] = new MenuCommand();
    m_command_map["brick"] = new BrickCommand();
    m_command_map["ball"] = new BallCommand();
    m_command_map["paddle"] = new PaddleCommand();
    m_command_map["information"] = new InformationCommand();
    ...
    m_command_map["if"] = new IfCommand();
     m_command_map["store"] = new StoreCommand();
